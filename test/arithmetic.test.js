...
describe('Subtraction', function () {
    ...
    it('subtracts two negative integers', function (done) {
        request.get('/arithmetic?operation=subtract&operand1=-21&operand2=-63')
            .expect(200)
            .end(function (err, res) {
                expect(res.body).to.eql({ result: 42 });
                done();
    ...
    it('rejects missing operand2', function (done) {
        request.get('/arithmetic?operation=subtract&operand1=21')
            .expect(400)
            .end(function (err, res) {
    ...
    describe('Power', function () {
        ...
        it('supports fractional exponents', function (done) {
        ...
        it('supports exponential notation for operands', function (done) {
            request.get('/arithmetic?operation=power&operand1=1.2e2&operand2=1e0')
                .expect(200)
                .end(function (err, res) {
